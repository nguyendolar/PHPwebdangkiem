            ...
            <main>
                <div class="container-fluid px-4">
                    <div class="card mb-4 mt-4">
                        ...
                        <div class="col-3">
                        <span style="margin-bottom : 10px"> Từ ngày : </span>
                        <input type="date" class="form-control" name="start" required >
                        </div>
                        <div class="col-3">
                        <span style="margin-bottom : 10px"> Đến ngày : </span>
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <?php 
                                   ...
                                   $start = $_POST['start'];
                                   $end = $_POST['end'];
                                   echo "<h4>Danh sách phương tiện đăng kiểm từ ngày ".$start." đến ngày ".$end." </h4>";
                                   $query = "SELECT a.*,b.tenloaixe,b.giadangkiem FROM profile as a,loaixe as b WHERE a.loaixe = b.id AND DATE(ngaydangkiem) BETWEEN '{$start}' AND '{$end}' ORDER BY a.id DESC";
