...
define("SMTP_UNAME", "websitedoan@gmail.com"); //Username for SMTP authentication any valid email created in your domain
define("SMTP_PWORD", "passnhutren123"); //Password for SMTP authentication
